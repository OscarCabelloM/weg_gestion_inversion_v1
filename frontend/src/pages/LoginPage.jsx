...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-dvh bg-slate-950 text-slate-100 flex font-sans selection:bg-blue-500 selection:text-slate-950">
      {/* Panel de marca */}
      <aside className="hidden lg:flex flex-col justify-between w-2/5 max-w-lg p-10 border-r border-slate-800 bg-slate-900/40">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight text-white">Gestión_Inversiones.v.1.8</h1>
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="lg:hidden flex items-center gap-3">
            ...
            <h1 className="text-lg font-bold text-white">Gestión_Inversiones.v.1.8</h1>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-800 rounded-lg pl-10 pr-3 py-2.5 text-base text-slate-200 placeholder:text-slate-600 focus:outline-none focus:border-blue-500 transition"
                />
              </div>
            </div>
